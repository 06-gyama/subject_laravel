...
<body>
    ...
    <script>
        // profile.blade.phpのボタンからモーダルへ値を受けわたす
        $('#testModal').on('show.bs.modal', function (event) {
            // ボタンを取得
            var button = $(event.relatedTarget);
            // data-post_atの部分を取得
            var post_at = button.data('post_at');
            var modal = $(this);
            // モーダルに取得したパラメータを渡す
            // 以下ではモーダル内のinputのクラス名を取得している
            modal.find('.modal-post_at').val(post_at);
        });
    </script>
</body>
</html>
